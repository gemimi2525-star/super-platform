...
/**
 * Props for ClientVerifyPanel - all strings pre-translated from server
 */
export interface ClientVerifyPanelProps {
    translations: {
        inputLabel: string;
        ...
        resultValidDesc: string;
        resultInvalidDesc: string;
        fieldDecisionId: string;
        fieldPolicy: string;
        fieldDecision: string;
        fieldIntentHash: string;
        fieldLedgerHash: string;
        fieldSignature: string;
        fieldIssuedAt: string;
...
export default function ClientVerifyPanel({ translations: t }: ClientVerifyPanelProps) {
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-lg shadow-md p-8 mb-8">
                <h2 className="text-2xl font-bold mb-4">{t.inputLabel}</h2>
                <textarea
                ...
                <div className="bg-white rounded-lg shadow-md p-8">
                    ...
                    {result.verification?.valid ? (
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-3xl font-bold text-success mb-2">{t.resultValid}</h3>
                            <p className="text-neutral-600">{t.resultValidDesc}</p>
                        </div>
                    ) : (
                        <div className="text-center py-8">
                            <div className="text-6xl mb-4">❌</div>
                            <h3 className="text-3xl font-bold text-error mb-2">{t.resultInvalid}</h3>
                            <p className="text-neutral-600 mb-4">{t.resultInvalidDesc}</p>
                        ...
                        <div className="mt-8 border-t pt-8">
                            ...
                            <table className="w-full">
                                <tbody className="divide-y">
                                    <tr>
                                        <td className="py-3 font-semibold w-48">{t.fieldDecisionId}</td>
                                        <td className="py-3 font-mono text-sm">{result.bundle.decisionId}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldPolicy}</td>
                                        <td className="py-3 font-mono text-sm">
                                            {result.bundle.policyId}@{result.bundle.policyVersion}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldDecision}</td>
                                        <td className="py-3">
                                            <span
                                    ...
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldIntentHash}</td>
                                    ...
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldLedgerHash}</td>
                                        <td className="py-3 flex items-center gap-2">
                                    ...
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldSignature}</td>
                                        <td className="py-3 flex items-center gap-2">
                                    ...
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldIssuedAt}</td>
                                        <td className="py-3 font-mono text-sm">
                                            {new Date(result.bundle.issuedAt).toLocaleString()}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="py-3 font-semibold">{t.fieldAuthority}</td>
