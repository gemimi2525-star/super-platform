/**
 * API — POST /api/os/notifications/clear (Phase 18)
 * Records a notification clear event in the audit trail.
 */
...
export async function POST(request: NextRequest) {
    try {
        ...
        const envelope = createAuditEnvelope(AUDIT_EVENTS.NOTIFICATION_CLEARED, {
            traceId: `notif-clear-${Date.now()}`,
            severity: 'INFO',
        ...
        console.error('[API/os/notifications/clear] Error:', error.message);
