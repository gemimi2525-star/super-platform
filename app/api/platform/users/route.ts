...
import type { PlatformUser, CreateUserRequest, PlatformRole } from '@/lib/platform/types';
import { DEFAULT_ROLE_PERMISSIONS, ROLE_HIERARCHY, hasPermission } from '@/lib/platform/types';
...
export async function GET(request: NextRequest) {
    try {
        ...
        const usersSnap = await db.collection('platform_users')
...
export async function POST(request: NextRequest) {
    try {
        ...
        await db.collection('platform_users').doc(firebaseUser.uid).set(newUser);
