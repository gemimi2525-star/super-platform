                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        <input
                            ...
                            style={{
                                width: '100%', padding: '12px 16px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.4)',
                                background: 'rgba(255,255,255,0.8)', fontSize: 14, outline: 'none', textAlign: 'center',
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: 'rgba(255,255,255,0.5)', color: '#333', fontSize: 14, fontWeight: 600,
