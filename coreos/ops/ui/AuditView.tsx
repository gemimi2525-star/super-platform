...
/**
 * AuditView — Placeholder (Phase 26A)
 *
 * Shared placeholder for the Audit tab.
 * Used by /ops/audit page and OS Shell Monitor Hub.
 */
...
export function AuditView() {
    return (
        <div style={s.root}>
            ...
            <h3 style={s.title}>Audit — Coming Soon</h3>
