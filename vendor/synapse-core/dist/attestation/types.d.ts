...
export declare const ATTESTATION_VERSION: "1.0";
/** Signature algorithm (LOCKED) */
export declare const SIGNATURE_ALGORITHM: "ed25519";
/** Tool version for manifest */
export declare const TOOL_VERSION: "coreos-attestation-1.0.0";
/**
