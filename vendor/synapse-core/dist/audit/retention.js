...
exports.evaluateRetention = evaluateRetention;
exports.splitForRotation = splitForRotation;
exports.redactPayload = redactPayload;
exports.redactRecord = redactRecord;
/**
 * Evaluate if retention policy requires rotation
 */
function evaluateRetention(records, policy, currentTime = Date.now()) {
 ...
 */
function splitForRotation(records, evaluation) {
